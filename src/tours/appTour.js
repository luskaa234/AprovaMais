...
export const appTour = [
  step(null, "Bem-vindo ao Aprova Mais", "Este guia mostra o caminho principal: acompanhar desempenho, estudar pelo plano, resolver questoes, fazer simulados e ajustar seu perfil. Use Proximo para avancar ou Pular quando quiser.", {
    mascot: "welcome",
  }),
  step("tour-dashboard", "Dashboard", "A primeira tela resume seu dia. Volte aqui para ver sua meta, sequencia, taxa de acerto, revisoes pendentes e os atalhos para continuar estudando.", {
    route: "dashboard",
    mobileMenu: false,
  }),
  ...
  step("tour-ajuda", "Central de Ajuda", "Abra a Ajuda para rever o tutorial geral ou iniciar um guia especifico da tela em que estiver.", {
    route: "ajuda",
    mobileMenu: false,
  }),
