...
export const navItems = [
  ...
  { key: "questoes", label: "Banco de questoes", icon: BookOpen, tourId: "tour-questoes" },
  ...
  { key: "revisao", label: "Central de revisao", icon: RefreshCw },
  ...
  { key: "redacao", label: "Redacao", icon: PenLine, tourId: "tour-redacao" },
