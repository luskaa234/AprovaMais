  ...
  return (
    <button
      className={cx(
        ...
        active ? "border-royal bg-royal text-white shadow-sm shadow-blue-200" : "border-royal/20 bg-white text-slate-700 hover:border-sky hover:bg-royal/10"
      )}
      onClick={onClick}
      type="button"
    >
  ...
  return (
    <button
      className={cx(
        ...
        active ? "border-royal bg-royal text-white" : "border-royal/20 bg-white text-slate-700 hover:border-sky hover:bg-royal/10"
      )}
      onClick={onClick}
      type="button"
    >
    ...
    <main className="min-h-screen bg-slate-50 px-4 py-6 text-slate-950 sm:px-6 lg:px-8">
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] max-w-6xl flex-col">
        <div className="mb-6 flex items-center justify-between gap-4">
          ...
          <span className="rounded-full border border-royal/20 bg-white px-3 py-1 text-xs font-bold text-navy shadow-sm">
            Etapa {step + 1} de {stepTitles.length}
          </span>
        </div>

        <div className="mb-6 h-2 overflow-hidden rounded-full bg-royal/15">
        ...
        <section className="grid flex-1 gap-6 lg:grid-cols-[320px_1fr]">
          <aside className="rounded-lg border border-royal/20 bg-white p-4 shadow-sm">
            <span className="inline-flex items-center gap-2 rounded-full border border-royal/20 bg-royal/10 px-3 py-1 text-xs font-bold text-navy">
              <Sparkles size={14} />
            ...
            <div className="mt-6 rounded-lg border border-royal/20 bg-royal/10 p-4">
              <div className="mx-auto grid size-14 place-items-center rounded-2xl bg-royal text-white">
                <Sparkles size={26} />
              </div>
              ...
              {stepTitles.map((title, index) => (
                <button
                  className={cx(
                    ...
                    index === step ? "bg-royal text-white" : index < step ? "bg-royal/10 text-blue-800" : "text-slate-500 hover:bg-royal/10"
                  )}
                  key={title}
          ...
          <form className="rounded-lg border border-royal/20 bg-white p-4 shadow-sm sm:p-6" onSubmit={(event) => event.preventDefault()}>
            <div className="mb-5">
            ...
            {step === 1 ? (
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                {form.objective === "geral" ? (
                  <div className="rounded-lg border border-royal/20 bg-royal/10 p-4 text-sm text-blue-900 sm:col-span-2">
            ...
            {step === 5 ? (
              <div className="grid gap-5">
                ...
                {form.editalOption === "upload-pdf" ? (
                  <label className="grid min-h-36 cursor-pointer place-items-center rounded-lg border border-dashed border-blue-200 bg-royal/10 p-6 text-center hover:border-blue-500">
            ...
            {step === 6 ? (
              <div className="grid gap-4">
                <div className="rounded-lg border border-blue-500/30 bg-royal/10 p-4">
                ...
                <div className="grid gap-4 lg:grid-cols-2">
                  <section className="rounded-lg border border-royal/20 bg-royal/10 p-4">
                    <h3 className="mb-3 font-bold">Matérias prioritárias</h3>
                    <div className="flex flex-wrap gap-2">
                      {diagnosticPlan.prioritySubjects.map((subject) => (
                        <span className="rounded-full bg-white px-3 py-1 text-xs font-bold text-navy ring-1 ring-royal/20" key={subject}>{subject}</span>
                      ))}
                    </div>
                  </section>
                ...
                <section className="rounded-lg border border-royal/20 bg-royal/10 p-4">
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    {diagnosticPlan.weeklySchedule.map((day) => (
                      <div className="rounded-lg bg-white p-3 ring-1 ring-royal/20" key={day.day}>
            ...
            <div className="mt-6 flex flex-col gap-3 border-t border-royal/20 pt-5 sm:flex-row sm:items-center sm:justify-between">
