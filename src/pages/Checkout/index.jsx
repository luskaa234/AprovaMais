...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f7fb]">
      {/* Cabeçalho */}
      <header className="sticky top-0 z-20 border-b border-blue-100 bg-white/95 backdrop-blur-sm">
        <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4">
          ...
          <span className="text-base font-black tracking-tight text-blue-700">VemAprovar</span>
              ...
              {method === "pix" && !pixData && (
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    disabled={pixLoading}
                    className="w-full rounded-xl bg-blue-600 py-3.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-blue-700 active:bg-blue-800 disabled:cursor-not-allowed disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2"
                  >
                    {pixLoading ? (
        ...
        className={cx(
          ...
          error
            ...
            : readOnly
              ...
              : "border-slate-200 bg-white focus-visible:border-blue-500 focus-visible:ring-blue-100"
        )}
        {...inputProps}
      />
      {error && (
...
function OrderSummaryCard({ plan, benefits, compact = false }) {
  return (
    <div className={cx("rounded-2xl border border-blue-100 bg-white shadow-sm", compact ? "p-4" : "p-5")}>
      {/* Cabeçalho */}
