...
export default function CardBrick({ plan, validate, user, onSuccess }) {
  ...
  }, [plan.id, plan.priceInCents, user?.email]);
      ...
      {ready && (
        <>
          ...
          <button
            ...
            disabled={loading}
            className="mt-5 w-full rounded-xl bg-royal py-3.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-navy active:bg-blue-800 disabled:cursor-not-allowed disabled:opacity-60"
          >
            {loading ? (
